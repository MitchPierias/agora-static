...
const IndexPage = () => (
  <Layout>
    ...
    <div style={{margin:"0 auto",maxWidth:"100vw",overflow:"hidden",textAlign:"center",color:"#FFFFFF",height:"100vh",display:"flex",flexDirection:"column",justifyContent:"flex-end",alignItems:"center"}}>
      ...
      <svg height={80} width="100%" style={{minWidth:960}} viewBox="0 0 64 64" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
